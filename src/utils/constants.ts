export const sampleListA = [
  { id: 'BTC', name: 'Bitcoin', symbol: 'BTC', canPurchase: true },
  { id: 'ETH', name: 'Ethereum', symbol: 'ETH', canPurchase: true },
...
export const sampleListB = [
  ...
  { id: 'AUD', name: 'Australian Dollar', symbol: '$', code: 'AUD', canPurchase: true },
